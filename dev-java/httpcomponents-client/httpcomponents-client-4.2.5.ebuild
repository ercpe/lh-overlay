...
EANT_GENTOO_CLASSPATH="commons-logging,commons-codec,httpcomponents-core,ehcache-1.2,spymemcached"
...
src_install() {
	for mod in httpclient httpclient-cache httpmime fluent-hc; do
		java-pkg_dojar ${mod}/target/${mod}.jar
	done
