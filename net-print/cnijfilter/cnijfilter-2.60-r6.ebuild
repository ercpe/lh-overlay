...
_pruse=("ip2200" "ip4200" "ip6600d" "ip7500" "mp500")
_prname=(${_pruse[@]})
_prid=("256" "260" "265" "266" "273")
_prcomp=("ip1600/2200 mp150/170/450" "ip4200 mp500" "ip6600d/6600pd" "ip7500" "ip4200 mp500")
...
src_unpack() {
	...
	epatch ${FILESDIR}/cnijfilter-2.60-r1-pstocanonij-c.patch || die
	if use "ip4200" || ${_autochoose}; then
		epatch ${FILESDIR}/cnijfilter-2.60-r1-canonip4200-ppd.patch || die
	fi
}
