# ==========================================================================
# This ebuild come from java-overlay repository. Zugaina.org only host a copy.
...
patch-apply() {
	...
	if ! use java6; then
		...
		sed -e "/id=\"org.eclipse.jdt.apt.pluggable.core\"/,/ /dev/null
	# %patch53
	...
	sed -i '// a\
			'  plugins/org.eclipse.help.webapp/build.xml
	...
	sed -i 	'// a\
		 ...
		 \
			 \
			 \
		' plugins/org.eclipse.core.runtime.compatibility.registry/build.xml
