...
SRC_URI="http://www.bernstein-plus-sons.com/software/${MY_P}.tar.gz
	 test? ( http://arcib.dowling.edu/software/CBFlib/downloads/version_${PV}/${MY_P}_Data_Files_Input.tar.gz
		 http://arcib.dowling.edu/software/CBFlib/downloads/version_0.7.9/CBFlib_0.7.9_Data_Files_Output.tar.gz )"
