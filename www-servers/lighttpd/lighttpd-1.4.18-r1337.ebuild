...
# $Header: /var/cvsroot/gentoo-x86/www-servers/lighttpd/lighttpd-1.4.18.ebuild,v 1.7 2008/01/10 08:40:28 vapier Exp $
...
src_unpack() {
	...
	use mysql && epatch ${FILESDIR}/lighttpd-1.4.18-mysql_auth.patch
